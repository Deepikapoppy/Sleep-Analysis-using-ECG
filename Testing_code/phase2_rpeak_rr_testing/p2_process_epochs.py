"""
=============================================================================
phase2_rpeak_rr_testing/p2_process_epochs.py
Step 4 — Run calibrated cascade detection on every epoch.
IDENTICAL logic to the training pipeline (fully signal-agnostic, no
dataset-specific branching). Only internal imports switched to relative.
=============================================================================
"""
