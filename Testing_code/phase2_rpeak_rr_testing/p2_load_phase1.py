"""
=============================================================================
phase2_rpeak_rr_testing/p2_load_phase1.py
Step 1 — Load all Phase-1 outputs from disk for a DEVICE session.
...
Phase 1 outputs load exactly the same way an slpdb/hmc record's would.
