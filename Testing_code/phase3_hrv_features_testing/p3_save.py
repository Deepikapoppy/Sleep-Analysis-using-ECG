"""
=============================================================================
phase3_hrv_features_testing/p3_save.py
Save Phase 3 outputs and update SQLite (optional) for a DEVICE session.
...
def save_phase3_results(df: pd.DataFrame,
    ...
    # ── Tier feature counts ───────────────────────────────────────────────────
    from .p3_sqi_gate   import SQI_GATE_COLS
    from .p3_postprocess import _ZSCORE_FEATURES
