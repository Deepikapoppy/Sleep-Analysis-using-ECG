"""
=============================================================================
phase4_sleep_classification/p4_logging.py
Logging setup for Phase 4 — mirrors Phase 3 style.
=============================================================================
"""
...
def setup_logger(name: str = "phase4",
                 log_dir: str = "logs",
                 log_file: str = "phase4.log") -> logging.Logger:
...
def log_phase_header(logger: logging.Logger,
                     ...
                     n_epochs: int) -> None:
    logger.info("=" * 70)
    logger.info("  PHASE 4 — Rule-Based Sleep Stage Classification (ECG Hypnogram)")
